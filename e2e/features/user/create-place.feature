Feature: User: login
  ...
  Scenario: Create a place from sidebar; state 1
    ...
    When I wait 5s
    Given I fill "Marketing Development" with "test-create-place21"
    When I wait 5s
    Given I Click id "PlaceID"
    When I wait 5s
    Given I clear input by id "change-place-id"
    When I wait 5s
    Given I fill id "change-place-id" with "create21"
    When I wait 5s
    ...
    When I wait 5s
    Then should the title of the place be "test-create-place21"

  Scenario: Delete grand place
    Given I Click on "create21" place
    When I wait 5s
    Given I Click id "navbar-popover"
    When I wait 5s
    Given I Click Link by Partial Text "Leave and Delete"
    When I wait 5s
    Given I Click Link by Partial Text "Delete this Place"
    When I wait 5s
    Given I fill "Place ID" with "create21"
    When I wait 5s
  ...
  Scenario: Create a place from sidebar; state 2
    ...
    Given I Click id "close-setting-place"
    When I wait 5s
    Then should the title of the place be "test-create-place25"
