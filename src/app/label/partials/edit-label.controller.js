(function() {
  ...
  function editLabelController($q, $uibModalInstance, $uibModal, $filter,
     toastr, _, NstSvcLabelFactory, NstSvcTranslation, NstSvcLogger, argv) {
    ...
    function removeLabel() {
      $uibModal.open({
        ...
        NstSvcLabelFactory.remove(vm.id).then(function () {
