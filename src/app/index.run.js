(function () {
  ...
  function runBlock($, $rootScope, $templateCache, iScrollService, $http, deviceDetector, SvcCardCtrlAffix,
    ...
    $templateCache.put(
      ...
      "<div ng-switch-default ng-if=\"title\" class=\"{{titleClass}}\" aria-label=\"{{title}}\">{{title}}</div><div ng-switch-default" + 
      "class=\"{{messageClass}}\" aria-label=\"{{message}}\">{{message}}</div><div ng-switch-when=\"true\" ng-if=\"title\" class=\"{{titleClass}}\"" +
