(function() {
  ...
  angular
    ...
    .constant('NST_LOCALE_FA_IR', {
      ...
      "All <b>{{ctlCreate.grandPlace.name}}</b> Members ({{ctlCreate.grandPlace.getTeammatesCount()}})": "همه اعضای <b>{{ctlCreate.grandPlace.name}}</b> ({{ctlCreate.grandPlace.getTeammatesCount()}})",
      ...
      "All <b>{{ctlCreate.parentPlace.name}}</b> Members ({{ctlCreate.parentPlace.getTeammatesCount()}})": "همه b>{{ctlCreate.parentPlace.name}}</b> اعضا ({{ctlCreate.parentPlace.getTeammatesCount()}})",
      ...
      "{{ctlTeammates.place.getTeammatesCount()}} Members": " {{ctlTeammates.place.getTeammatesCount()}} عضو"
    });
})();
