(function() {
  ...
  angular
    ...
    .constant('NST_LOCALE_FA_IR', {
      ...
      "Everyone can send their messages to <b>...</b> Place. This includes messages sent from different email platforms to your Nested address ({{(ctlCreate.placesParts ? ctlCreate.placesParts.join('.') + '.' : '') + (ctlCreate.place.id || '')}}@nested.me).": "همه افراد دارای سرویس ایمیل می توانند پست‌ خود را به Place <b>...</b> با آدرس نستد ({{(ctlCreate.placesParts ? ctlCreate.placesParts.join('.') + '.' : '') + (ctlCreate.place.id || '')}}@nested.me) به اشتراک بگذارند.",
      ...
      "Everyone can send their messages to <b>{{ctlCreate.place.name}}</b> Place. This includes messages sent from different email platforms to your Nested address ({{(ctlCreate.placesParts ? ctlCreate.placesParts.join('.') + '.' : '') + (ctlCreate.place.id || '')}}@nested.me).": "همه افراد دارای سرویس‌های مختلف ایمیل می‌توانند به ‌Place‌ <b>{{ctlCreate.place.name}}</b> با آدرس نستد ({{(ctlCreate.placesParts ? ctlCreate.placesParts.join('.') + '.' : '') + (ctlCreate.place.id || '')}}@nested.me) پست به اشتراک بگذارند.",
