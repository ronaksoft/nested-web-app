(function() {
  ...
  angular
    ...
    .constant('NST_LOCALE_FA_IR', {
      ...
      "Create a Grand Place<span>Step 1/2</span>": "ساختGrand Place <span>مرحله 1/2 </span>",
      "Create a Grand Place<span>Step 2/2</span>": "ساختGrand Place <span>مرحله 2/2 </span>",
      "Create a Private Place<span>Step 1/2</span>": "ساختPrivate Place <span>مرحله 1/2 </span>",
      ...
      "Members ({{ctrl.place.counters.creators + ctrl.place.counters.key_holders}})": "اعضای {{ctrl.place.counters.creators + ctrl.place.counters.key_holders}}",
      ...
      "Place Description <span>Optional</span>": "شرحPlace  <span></span> اختیاری",
      ...
      "{{grandPlaceName}} Members": "{{grandPlaceName}} اعضا ",
      "{{placeName}} Managers": "{{placeName}}مدیران",
      "{{placeName}} Managers and Members": "میران و اعضای {{placeName}}"
    });
})();
