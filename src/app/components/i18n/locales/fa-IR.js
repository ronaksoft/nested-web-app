(function() {
  ...
  angular
    ...
    .constant('NST_LOCALE_FA_IR', {
      ...
      "Are you sure to demote {0} of members?": "آیا از محدود کردن دسترسی {0} مطمئن هستید؟",
      "Are you sure to promote {0} of members?": "آیا از ترفیع دادن دسترسی {0} مطمئن هستید؟",
      "Are you sure to remove {0} of members?": "آیا از حذف  {0} مطمئن هستید؟",
