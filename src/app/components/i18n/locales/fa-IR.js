(function() {
  ...
  angular
    ...
    .constant('NST_LOCALE_FA_IR', {
      ...
      "Everyone can send their messages to <b>...</b> Place. This includes messages sent from different email platforms to your Nested address ({{(ctlCreate.placesParts ? ctlCreate.placesParts.join('.') + '.' : '') + (ctlCreate.place.id || '')}}@nested.me).": "همه کاربران اینترنتی داری ایمیل‌های متفاوت می‌توانند بهPlace‌ <b>...</b>به آدرس نستد({{(ctlCreate.placesParts ? ctlCreate.placesParts.join('.') + '.' : '') + (ctlCreate.place.id || '')}}@nested.me) پست ارسال کنند",
      ...
      "Everyone can send their messages to <b>{{ctlCreate.place.name}}</b> Place. This includes messages sent from different email platforms to your Nested address ({{(ctlCreate.placesParts ? ctlCreate.placesParts.join('.') + '.' : '') + (ctlCreate.place.id || '')}}@nested.me).": "همه کاربران اینترنتی داری ایمیل‌های متفاوت می‌توانند به Place  <b>{{ctlCreate.place.name}}</b>از ایمیل سرویس‌های مختلف به آدرس نستد ({{(ctlCreate.placesParts ? ctlCreate.placesParts.join('.') + '.' : '') + (ctlCreate.place.id || '')}}@nested.me)پست ارسال کنند.",
