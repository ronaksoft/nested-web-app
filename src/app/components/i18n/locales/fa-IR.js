(function() {
  ...
  angular
    ...
    .constant('NST_LOCALE_FA_IR', {
      ...
      "\n        All &#x201D;{{ctrl.grandPlace.name}}&#x201D; Members can view and comment on the posts of this Place.\n      ": "همه اعضای {{ctrl.grandPlace.name}} می‌توانند پست‌های داخل Place را ببینند و نظر بدهند.",
      ...
      "Cancel": "لغو",
      "Change": "تغییر",
      "Change Place Picture": "تعویض تصویر Place",
      ...
      "Create a Common Place<span>Step 1/2</span>": "ساختCommon Place <span>مرحله 1/2 </span>",
      "Create a Common Place<span>Step 2/2</span>": "ساختCommon Place <span>مرحله 2/2 </span>",
      ...
      "Discard": "منصرف شدن",
      "Do not end your username with a dash (-)": "در انتهای نام کاربری نمی توانید از خط تیره (-) استفاده کنید",
      ...
      "Enter your phone number to help you sign back in to Nested.": "درج شماره تلفن به منظور بازگشت ب نستد",
      ...
      "Fit Your Image": "اندازه تصویر خود را مشخص کنید",
      ...
      "Having your Search turned on, anyone can reach you, even without knowing your ID.": "با فعال کردن گزینه جستجو، هر شخصی حتی بدون دانستن شناسه کاربری‌تان می‌تواند شما را پیدا کند. ",
      ...
      "One comment": "یک نظر",
      "One post": "یک پست ",
      "Only I can share posts and files in this Place.": "فقط من می‌توان در این Place پست‌ها و فایل‌ه را به اشتراگک بکذارم.",
      ...
      "To create an account with Nested, please enter your phone number.": "لطفاشماره تلفن همراه خود وارد کنید.",
      ...
      "You can modify your profile settings here": "شما از اینجا می‌توانید تنظیمات پروفایل را  تغییر دهید",
      ...
      "successfully created": "ساخت با موفقیت",
      "try again": "تلاش مجدد",
      "try now": "تلاش مجدد",
