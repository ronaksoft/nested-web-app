(function() {
  ...
  angular
    ...
    .constant('NST_LOCALE_FA_IR', {
      "_direction": "rtl",
      " accepted your invitation to {{notification.invitation.place.name}} (#{{notification.invitation.place.id}})": "دعوت به Place \r\n {{notification.invitation.place.name}} (#{{notification.invitation.place.id}}) را پذیرفت",
      ...
      "All <b>{{ctlCreate.grandPlace.name}}</b> Members can view Place contents.": "همه اعضای<b>{{ctlCreate.grandPlace.name}}</b>\r\nمی‌توانند محتوای درون Place‌را ببینند.",
