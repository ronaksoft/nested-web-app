(function() {
  ...
  angular
    ...
    .constant('NST_LOCALE_FA_IR', {
      ...
      "<b>{{ ::notification.invitation.invitee.fullName }}</b> accepted your invitation to <b>{{notification.invitation.place.name}} (#{{notification.invitation.place.id}})</b>": "<b>{{ ::notification.invitation.invitee.fullName }}</b> \r\nدعوت شما به  <b>{{notification.invitation.place.name}} (#{{notification.invitation.place.id}})</b> را پذیرفت",
      ...
      "Everyone can send their messages to <b>...</b> Place. This includes messages sent from different email platforms to your Nested address ({{ctlCreate.place.id}}@nested.me).": "همه کاربران اینترنتی داری ایمیل‌های متفاوت می‌توانند بهPlace‌ \r\n<b>...</b>به آدرس نستدشما پست ارسال کنند.({{ctlCreate.place.id}}@nested.me)",
      "Everyone can send their messages to <b>...</b> Place. This includes messages sent from email platforms to your Nested address ({{ctlSettings.place.id}}@nested.me).": "همه کاربران اینترنتی داری ایمیل‌می‌توانند بهPlace‌ \r\n<b>...</b>به آدرس نستدشما پست ارسال کنند.({{ctlCreate.place.id}}@nested.me)",
      "Everyone can send their messages to <b>{{ctlCreate.place.name}}</b> Place. This includes messages sent from different email platforms to your Nested address ({{ctlCreate.place.id}}@nested.me).": "همه کاربران اینترنتی داری ایمیل‌های متفاوت می‌توانند بهPlace‌ \r\n<b>{{ctlCreate.place.name}}</b>از ایمل سرویس‌های مختلف به آدرس نستدشما پست ارسال کنند.({{ctlCreate.place.id}}@nested.me)",
      "Everyone can send their messages to <b>{{ctlSettings.place.name}}</b> Place. This includes messages sent from email platforms to your Nested address ({{ctlSettings.place.id}}@nested.me).": "همه کاربران اینترنتی داری ایمیل‌های متفاوت می‌توانند بهPlace‌ \r\n<b>{{ctlSettings.place.name}}</b>از ایمل سرویس‌های مختلف به آدرس نستدشما پست ارسال کنند. ({{ctlSettings.place.id}}@nested.me).",
      ...
      "Only Members can post messages to <b>{{ctlCreate.place.name ? ctlCreate.place.name : '...'}}</b> Place.": "فقط اعضا می‌توانند به Place \r\n<b>{{ctlCreate.place.name ? ctlCreate.place.name : '...'}}</b> پست بدهند.",
      ...
      "Only {{ ctlCreate.grandPlace.name }} Members can post messages to <b>{{ ctlCreate.place.name }}</b> Place.": "فقط اعضای {{ ctlCreate.grandPlace.name }} می‌توانند به Place‌\r\n<b>{{ ctlCreate.place.name }}</b>پست بدهند.",
      ...
      "Show in the search result of Members from {{ctlSettings.grandPlace.name}}?": "نتایج جستجوی اعضا از {{ctlSettings.grandPlace.name}}?",
      ...
      "Total unseen posts&#xA0; ": "مجموع پست‌های خوانده نشده",
      ...
      "removed {{::act.member.fullName}} from here": "حذف  {{::act.member.fullName}} از",
      "try again": "تلاش مجدد",
      "try now": "تلاش مجدد",
      ...
      "year": "سال",
      "{0} User(s) has not been added to Place {1}.": "کاربر{0} به ‌Place \r\n {1} اضافه نشده",
      "{0} User(s) has not been invited to Place {1}.": "کاربر{0} به ‌Place \r\n {1} دعوت نشده",
      "{0} user has been {1} to Place \"{2}\" successfully.": "کاربری به Place \r\n \"{2}\" {1}نشده ",
      "{0} user/s has been {1} to Place \"{2}\" successfully.": " {0}کاربر به Place \r\n \"{2}\" {1}شده ",
      "{0} user/s has not been added to Place {1}.": "کاربر/کاربران {0} به ‌Place \r\n {1} اضافه نشده",
      "{0} user/s has not been invited to Place {1}.": "کاربر/کاربران {0} به ‌Place \r\n {1} اضافه نشده",
      ...
      "{{ctlMessages.currentPlace.counters.posts}} posts": "{{ctlMessages.currentPlace.counters.posts}}پست‌ها",
      "{{ctlMessages.unreadCount}} Unseen": " {{ctlMessages.unreadCount}} خوانده نشده",
      "{{ctlPostCard.unreadCommentsCount}} new comments": " {{ctlPostCard.unreadCommentsCount}} نظرات جدید",
