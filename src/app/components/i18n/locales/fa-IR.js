(function () {
  ...
  angular
    ...
    .constant('NST_LOCALE_FA_IR', {
      ...
      "Share": "اشتراک گذاری",
      "a few seconds ago": "لحظاتی پیش",
      "in a few seconds": "لحظاتی پیش",
      "a minute ago": "دقیقه قبل",
      "minutes ago": "دقیقه قبل",
      "one day ago": "یک روز قبل",
      ...
      "Discard": "منصرف شدن",
      "Do you want to be searched by other Nested users?": "تمایل دارید توسط کاربران نستد قابل جستجو باشید؟",
      ...
      "Leaving {{leaveCtrl.place.name}}": "ترک کرد{{leaveCtrl.place.name}}",
