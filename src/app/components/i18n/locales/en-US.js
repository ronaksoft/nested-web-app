(function() {
  ...
  angular
    ...
    .constant('NST_LOCALE_EN_US', {
      ...
      "Add to favorite places": "Add to favorite Places",
      "Add to my Favorites": "Add to Favorites",
      ...
      "Everyone can send their messages to <b>...</b> Place. This includes messages sent from different email platforms to your Nested address ({{ctlCreate.place.id}}@nested.me).": "Everyone can share posts with <b>...</b> Place. This includes posts and emails sent from other emailing services to your Nested address ({{ctlCreate.place.id}}@nested.me).",
      ...
      "Everyone can send their messages to <b>{{ctlCreate.place.name}}</b> Place. This includes messages sent from different email platforms to your Nested address ({{ctlCreate.place.id}}@nested.me).": "Everyone can share posts with <b>{{ctlCreate.place.name}}</b> Place. This includes posts and emails sent from other emailing services to your Nested address ({{ctlCreate.place.id}}@nested.me).",
      ...
      "Remove from favorite places": " Remove from Favorites ",
