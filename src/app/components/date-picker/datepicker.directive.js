...
//         function ngJalaaliFlatDatepickerDirective($templateCache, $compile, $document, datesCalculator, moment, $http) {
...
//                     var html;
//                     var template
//                     $http.get('app/components/date-picker/datepicker.html', {cache: $templateCache}).success(function(tplContent){
//                         html = tplContent;
//                         $templateCache.put('datepicker.html', html);
//                         template = angular.element($templateCache.get('datepicker.html'));
//                         console.log('template0', template);
//                     });
//                     var dateSelected = '';
